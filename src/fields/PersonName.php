...
use newism\fields\assetbundles\personnamefield\PersonNameFieldAsset;
 ...
 * @since     1.0.0
 */
class PersonName extends PlainText implements PreviewableFieldInterface
{
    // Static Methods
    // =========================================================================
    ...
    )
    {
        ...
        if (is_array($value)) {
            $value = new PersonNameModel($value);
        }
